...
<head>
  ...
  <!--<script src="{{url('public/js/jquery-1.12.3.js')}}"></script>-->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{session::get('admin_name')}} - {{session::get('admin_status')}} Web Developer
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{session::get('admin_name')}} - {{session::get('admin_status')}}</p>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <li class="active"><a href="{{url('./admin/')}}"><i class="fa fa-circle-o"></i>Home</a></li>
          <li class="active"><a href="{{url('./articles/')}}"><i class="fa fa-circle-o"></i>Articles</a></li>
          <li class="active"><a href="{{url('./categories/')}}"><i class="fa fa-circle-o"></i>Categories</a></li>
          <li class="active"><a href="{{url('./types/')}}"><i class="fa fa-circle-o"></i>Types</a></li>
          <li class="active"><a href="{{url('./admin-news/')}}"><i class="fa fa-circle-o"></i>News</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
